...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0757/VSTAFF3.csv' OVERWRITE INTO TABLE VSTAFF3;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0757/STAFF3.csv' OVERWRITE INTO TABLE STAFF3;
