...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0496/VS1.csv' OVERWRITE INTO TABLE VS1;
CREATE TABLE BASE_VS1(C1 DOUBLE,C2 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0496/BASE_VS1.csv' OVERWRITE INTO TABLE BASE_VS1;
