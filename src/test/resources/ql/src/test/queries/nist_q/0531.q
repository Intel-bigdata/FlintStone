...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0531/PROJ1.csv' OVERWRITE INTO TABLE PROJ1;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0531/PROJ.csv' OVERWRITE INTO TABLE PROJ;
