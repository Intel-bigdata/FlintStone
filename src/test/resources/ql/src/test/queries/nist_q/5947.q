...
SELECT AVG(S_GRADE), COUNT(S_GRADE), S_EMPNUM FROM STAFF GROUP BY S_EMPNUM HAVING EXISTS (SELECT * FROM STAFF WHERE EXISTS (SELECT S_EMPNUM FROM STAFF WHERE S_EMPNUM <> 'E7 ')) AND S_EMPNUM > 'E1 ';
