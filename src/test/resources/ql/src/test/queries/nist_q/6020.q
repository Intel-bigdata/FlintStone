...
SELECT COUNT(*), S_CITY, S_GRADE FROM STAFF WHERE S_GRADE BETWEEN 11 AND (SELECT MAX(S_GRADE) FROM STAFF WHERE S_EMPNAME > 'AA') AND S_GRADE BETWEEN 12 AND 18 GROUP BY S_CITY, S_GRADE HAVING S_GRADE > (SELECT MIN(W_HOURS) FROM WORKS);
