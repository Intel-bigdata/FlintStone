...
SELECT * FROM WORKS CROSS JOIN PROJ WHERE W_PNUM = P_PNUM AND W_PNUM LIKE '_4%' AND W_EMPNUM NOT LIKE '%1%' AND P_BUDGET = (SELECT MIN(P_BUDGET) FROM PROJ WHERE P_PNUM = W_PNUM);
