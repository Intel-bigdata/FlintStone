...
SELECT AVG(S_GRADE), COUNT(S_GRADE), S_CITY, S_EMPNUM FROM STAFF GROUP BY S_CITY, S_EMPNUM HAVING EXISTS (SELECT W_HOURS FROM WORKS WHERE W_EMPNUM = S_EMPNUM) AND S_EMPNUM > 'E1 ';
