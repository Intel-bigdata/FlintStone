...
SELECT P_BUDGET*2/(P_BUDGET/3) FROM PROJ WHERE P_STARTDATE > DATE '2010-02-03' AND P_PNUM NOT IN (SELECT S_EMPNUM FROM STAFF WHERE S_GRADE > 11 AND P_PNUM = S_EMPNUM AND NOT EXISTS (SELECT * FROM WORKS WHERE W_EMPNUM LIKE '%9%_' AND W_HOURS < 13));
