...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0480/VBB.csv' OVERWRITE INTO TABLE VBB;
CREATE TABLE BB(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0480/BB.csv' OVERWRITE INTO TABLE BB;
