...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0519/PROJ1.csv' OVERWRITE INTO TABLE PROJ1;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0519/PROJ.csv' OVERWRITE INTO TABLE PROJ;
