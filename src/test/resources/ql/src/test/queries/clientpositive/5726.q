...
SELECT COUNT(*), S_CITY FROM STAFF WHERE S_GRADE <> (SELECT AVG(W_HOURS) FROM WORKS WHERE S_EMPNUM > W_EMPNUM AND S_GRADE < (SELECT MIN(W_HOURS) FROM WORKS)) GROUP BY S_CITY;
