...
SELECT AVG(W_HOURS), W_EMPNUM FROM WORKS WHERE EXISTS (SELECT * FROM STAFF WHERE S_EMPNUM > 'E3 ' AND S_GRADE BETWEEN 11 AND 16) AND W_PNUM > 'E1 ' GROUP BY W_EMPNUM HAVING AVG(W_HOURS) > 20;
