...
select sum(case when p_budget<=10000 then 10000.0 else p_budget end) from proj group by p_city, p_ptype order by sum(case when p_budget<=10000 then 10000.0 else p_budget end);
