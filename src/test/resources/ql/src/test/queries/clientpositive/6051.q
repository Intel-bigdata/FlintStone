...
SELECT AVG(W_HOURS+P_BUDGET/100), W_EMPNUM FROM WORKS, PROJ WHERE W_PNUM = P_PNUM AND P_CITY IN ('Deale          ', 'Vienna         ', 'Akron          ', 'Toyko          ') GROUP BY W_EMPNUM HAVING W_EMPNUM IN ('E1 ', 'E2 ', 'E4 ', 'E6 ');
