...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0530/PROJ1.csv' OVERWRITE INTO TABLE PROJ1;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0530/PROJ.csv' OVERWRITE INTO TABLE PROJ;
