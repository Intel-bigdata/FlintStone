...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0007/VVTABLE.csv' OVERWRITE INTO TABLE VVTABLE;
CREATE TABLE VII(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0007/VII.csv' OVERWRITE INTO TABLE VII;
CREATE TABLE VDD(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0007/VDD.csv' OVERWRITE INTO TABLE VDD;
CREATE TABLE VCC(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0007/VCC.csv' OVERWRITE INTO TABLE VCC;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0007/VBADG2.csv' OVERWRITE INTO TABLE VBADG2;
CREATE TABLE VAA(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0007/VAA.csv' OVERWRITE INTO TABLE VAA;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0007/BADG2.csv' OVERWRITE INTO TABLE BADG2;
CREATE TABLE BADG1(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0007/BADG1.csv' OVERWRITE INTO TABLE BADG1;
CREATE TABLE AA(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0007/AA.csv' OVERWRITE INTO TABLE AA;
