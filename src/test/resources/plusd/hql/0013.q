...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0013/VVTABLE.csv' OVERWRITE INTO TABLE VVTABLE;
CREATE TABLE VII(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0013/VII.csv' OVERWRITE INTO TABLE VII;
CREATE TABLE VDD(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0013/VDD.csv' OVERWRITE INTO TABLE VDD;
CREATE TABLE VCC(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0013/VCC.csv' OVERWRITE INTO TABLE VCC;
CREATE TABLE VBB(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0013/VBB.csv' OVERWRITE INTO TABLE VBB;
CREATE TABLE VBADG2(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0013/VBADG2.csv' OVERWRITE INTO TABLE VBADG2;
CREATE TABLE VAA(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0013/VAA.csv' OVERWRITE INTO TABLE VAA;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0013/VTABLE.csv' OVERWRITE INTO TABLE VTABLE;
CREATE TABLE SRCH1(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0013/SRCH1.csv' OVERWRITE INTO TABLE SRCH1;
CREATE TABLE JJ(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0013/JJ.csv' OVERWRITE INTO TABLE JJ;
CREATE TABLE II(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0013/II.csv' OVERWRITE INTO TABLE II;
