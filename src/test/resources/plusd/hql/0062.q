...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0062/VVTABLE.csv' OVERWRITE INTO TABLE VVTABLE;
CREATE TABLE VII(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0062/VII.csv' OVERWRITE INTO TABLE VII;
CREATE TABLE VDD(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0062/VDD.csv' OVERWRITE INTO TABLE VDD;
CREATE TABLE VCC(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0062/VCC.csv' OVERWRITE INTO TABLE VCC;
CREATE TABLE VBB(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0062/VBB.csv' OVERWRITE INTO TABLE VBB;
CREATE TABLE VBADG2(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0062/VBADG2.csv' OVERWRITE INTO TABLE VBADG2;
CREATE TABLE VAA(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0062/VAA.csv' OVERWRITE INTO TABLE VAA;
