...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/WORKWEEK.csv' OVERWRITE INTO TABLE WORKWEEK;
CREATE TABLE WCOV(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/WCOV.csv' OVERWRITE INTO TABLE WCOV;
CREATE TABLE VS6(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/VS6.csv' OVERWRITE INTO TABLE VS6;
CREATE TABLE VS5(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/VS5.csv' OVERWRITE INTO TABLE VS5;
CREATE TABLE VS4(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/VS4.csv' OVERWRITE INTO TABLE VS4;
CREATE TABLE VS3(C2 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/VS3.csv' OVERWRITE INTO TABLE VS3;
CREATE TABLE VS2(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/VS2.csv' OVERWRITE INTO TABLE VS2;
CREATE TABLE VS1(C1 DOUBLE,C2 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/VS1.csv' OVERWRITE INTO TABLE VS1;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/VERBOSE_INV.csv' OVERWRITE INTO TABLE VERBOSE_INV;
CREATE TABLE V0866(EMPNUM STRING,HOURS DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/V0866.csv' OVERWRITE INTO TABLE V0866;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/V0865.csv' OVERWRITE INTO TABLE V0865;
CREATE TABLE UUSIG(U1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/UUSIG.csv' OVERWRITE INTO TABLE UUSIG;
CREATE TABLE TYPE_TIMES(JOB_TYPE STRING,RUN_SECONDS INT) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/TYPE_TIMES.csv' OVERWRITE INTO TABLE TYPE_TIMES;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/SUBQ2.csv' OVERWRITE INTO TABLE SUBQ2;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/STANDARD_INPUT.csv' OVERWRITE INTO TABLE STANDARD_INPUT;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/STAFF_DUP.csv' OVERWRITE INTO TABLE STAFF_DUP;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/STAFF.csv' OVERWRITE INTO TABLE STAFF;
CREATE TABLE SPLAT_AVG(PLAYER_NO DOUBLE,SPLAT_SCORE DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/SPLAT_AVG.csv' OVERWRITE INTO TABLE SPLAT_AVG;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/QUALSTAR.csv' OVERWRITE INTO TABLE QUALSTAR;
CREATE TABLE PTypes(TYPE STRING,NUM DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/PTypes.csv' OVERWRITE INTO TABLE PTypes;
CREATE TABLE PROJ_HOURS(PNUM STRING,HOURS INT) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/PROJ_HOURS.csv' OVERWRITE INTO TABLE PROJ_HOURS;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/PEOPLE_ORDERS.csv' OVERWRITE INTO TABLE PEOPLE_ORDERS;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/INCOMPLETES.csv' OVERWRITE INTO TABLE INCOMPLETES;
CREATE TABLE FOUR_CITIES(C1 STRING,C2 STRING,C3 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/FOUR_CITIES.csv' OVERWRITE INTO TABLE FOUR_CITIES;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/EXON.csv' OVERWRITE INTO TABLE EXON;
CREATE TABLE DV1(HOURS DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/DV1.csv' OVERWRITE INTO TABLE DV1;
CREATE TABLE CTRANS(WIN_COUNT DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/CTRANS.csv' OVERWRITE INTO TABLE CTRANS;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/CORRSUBQ2.csv' OVERWRITE INTO TABLE CORRSUBQ2;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/CORRQUALSTAR.csv' OVERWRITE INTO TABLE CORRQUALSTAR;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/COMPLETES.csv' OVERWRITE INTO TABLE COMPLETES;
CREATE TABLE CHANGGVIEW(NAAM STRING,AGE DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/CHANGGVIEW.csv' OVERWRITE INTO TABLE CHANGGVIEW;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/ABOVE_AVERAGE.csv' OVERWRITE INTO TABLE ABOVE_AVERAGE;
CREATE TABLE YESMAIL(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/YESMAIL.csv' OVERWRITE INTO TABLE YESMAIL;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/WEIRDPAD.csv' OVERWRITE INTO TABLE WEIRDPAD;
CREATE TABLE VISCHANGE(C1 DOUBLE,C2 FLOAT) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/VISCHANGE.csv' OVERWRITE INTO TABLE VISCHANGE;
CREATE TABLE U_SIG(C1 DOUBLE,C_1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/U_SIG.csv' OVERWRITE INTO TABLE U_SIG;
CREATE TABLE UUUSIG(IRREVERENT DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/UUUSIG.csv' OVERWRITE INTO TABLE UUUSIG;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/USIG.csv' OVERWRITE INTO TABLE USIG;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/T0892.csv' OVERWRITE INTO TABLE T0892;
CREATE TABLE T0879(C1 DOUBLE,C2 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/T0879.csv' OVERWRITE INTO TABLE T0879;
CREATE TABLE T0878(C1 DOUBLE,C2 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/T0878.csv' OVERWRITE INTO TABLE T0878;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/T0865.csv' OVERWRITE INTO TABLE T0865;
CREATE TABLE T(A STRING,B STRING,C STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/T.csv' OVERWRITE INTO TABLE T;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/STAFF66.csv' OVERWRITE INTO TABLE STAFF66;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/SSSLOG.csv' OVERWRITE INTO TABLE SSSLOG;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/SPLAT_EM.csv' OVERWRITE INTO TABLE SPLAT_EM;
CREATE TABLE SLACK(SLACK_FACTOR FLOAT) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/SLACK.csv' OVERWRITE INTO TABLE SLACK;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/SEVEN_TYPES.csv' OVERWRITE INTO TABLE SEVEN_TYPES;
CREATE TABLE S(X STRING,Y STRING,Z STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/S.csv' OVERWRITE INTO TABLE S;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/RUN_TIMES.csv' OVERWRITE INTO TABLE RUN_TIMES;
CREATE TABLE REFERENCE_CHANGG(NAAM STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/REFERENCE_CHANGG.csv' OVERWRITE INTO TABLE REFERENCE_CHANGG;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/PAYMENTS.csv' OVERWRITE INTO TABLE PAYMENTS;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/ORDERS.csv' OVERWRITE INTO TABLE ORDERS;
CREATE TABLE ORANGES(KEY2 FLOAT,ORANGE_NAME STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/ORANGES.csv' OVERWRITE INTO TABLE ORANGES;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/OBITUARIES.csv' OVERWRITE INTO TABLE OBITUARIES;
CREATE TABLE NUM1(NUM1C1 DOUBLE,NUM1C2 DOUBLE,NUM1C3 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/NUM1.csv' OVERWRITE INTO TABLE NUM1;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/LUSER_DATA.csv' OVERWRITE INTO TABLE LUSER_DATA;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/LUSERS.csv' OVERWRITE INTO TABLE LUSERS;
CREATE TABLE LT2(PITCH DOUBLE,DEGREE DOUBLE,RUDDER DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/LT2.csv' OVERWRITE INTO TABLE LT2;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/LT1.csv' OVERWRITE INTO TABLE LT1;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/LOTSA_TYPES.csv' OVERWRITE INTO TABLE LOTSA_TYPES;
CREATE TABLE LOSSY_OUTPUT(PORTVAL DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/LOSSY_OUTPUT.csv' OVERWRITE INTO TABLE LOSSY_OUTPUT;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/LONG_NAMED_PEOPLE.csv' OVERWRITE INTO TABLE LONG_NAMED_PEOPLE;
CREATE TABLE LONG1(C1 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/LONG1.csv' OVERWRITE INTO TABLE LONG1;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/L1.csv' OVERWRITE INTO TABLE L1;
CREATE TABLE JNULL2(D1 DOUBLE,D2 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/JNULL2.csv' OVERWRITE INTO TABLE JNULL2;
CREATE TABLE JNULL1(C1 DOUBLE,C2 DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/JNULL1.csv' OVERWRITE INTO TABLE JNULL1;
CREATE TABLE ITEM_CODES(ITEMCODE DOUBLE,ITEMTEXT STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/ITEM_CODES.csv' OVERWRITE INTO TABLE ITEM_CODES;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/INVENTORY.csv' OVERWRITE INTO TABLE INVENTORY;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/CREATIONTIMES.csv' OVERWRITE INTO TABLE CREATIONTIMES;
CREATE TABLE COST_CODES(COSTCODE DOUBLE,COSTTEXT STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/COST_CODES.csv' OVERWRITE INTO TABLE COST_CODES;
CREATE TABLE CORRECT_OUTPUT(PORTVAL DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/CORRECT_OUTPUT.csv' OVERWRITE INTO TABLE CORRECT_OUTPUT;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/CONTACTS.csv' OVERWRITE INTO TABLE CONTACTS;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/AUDIT_CODES.csv' OVERWRITE INTO TABLE AUDIT_CODES;
CREATE TABLE APPLES(KEY1 DOUBLE,APPLE_NAME STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/APPLES.csv' OVERWRITE INTO TABLE APPLES;
CREATE TABLE ALL_USER_IDS(LUSER_ID DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0077/ALL_USER_IDS.csv' OVERWRITE INTO TABLE ALL_USER_IDS;
