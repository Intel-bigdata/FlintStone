...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/UPDATE_VIEW9.csv' OVERWRITE INTO TABLE UPDATE_VIEW9;
CREATE TABLE UPDATE_VIEW8(EMPNUM STRING,EMPNAME STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/UPDATE_VIEW8.csv' OVERWRITE INTO TABLE UPDATE_VIEW8;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/UPDATE_VIEW7.csv' OVERWRITE INTO TABLE UPDATE_VIEW7;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/UPDATE_VIEW6.csv' OVERWRITE INTO TABLE UPDATE_VIEW6;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/UPDATE_VIEW5.csv' OVERWRITE INTO TABLE UPDATE_VIEW5;
CREATE TABLE UPDATE_VIEW4(PNUM STRING,EMPNUM STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/UPDATE_VIEW4.csv' OVERWRITE INTO TABLE UPDATE_VIEW4;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/UPDATE_VIEW3.csv' OVERWRITE INTO TABLE UPDATE_VIEW3;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/UPDATE_VIEW2.csv' OVERWRITE INTO TABLE UPDATE_VIEW2;
CREATE TABLE UPDATE_VIEW1(CITY STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/UPDATE_VIEW1.csv' OVERWRITE INTO TABLE UPDATE_VIEW1;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/TESTREPORT.csv' OVERWRITE INTO TABLE TESTREPORT;
CREATE TABLE TEMP_SS(EMPNUM STRING,GRADE DOUBLE,CITY STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/TEMP_SS.csv' OVERWRITE INTO TABLE TEMP_SS;
CREATE TABLE SUBSP(EMPNUM STRING,PNUM STRING,HOURS DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/SUBSP.csv' OVERWRITE INTO TABLE SUBSP;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/SET_TEST.csv' OVERWRITE INTO TABLE SET_TEST;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/MULTI_YEAR_OBSERV.csv' OVERWRITE INTO TABLE MULTI_YEAR_OBSERV;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/EXTREME_TEMPS.csv' OVERWRITE INTO TABLE EXTREME_TEMPS;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/DUP_COL.csv' OVERWRITE INTO TABLE DUP_COL;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/DOMAIN_VIEW.csv' OVERWRITE INTO TABLE DOMAIN_VIEW;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/CELSIUS_OBSERV.csv' OVERWRITE INTO TABLE CELSIUS_OBSERV;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/WHICH_SCHEMA1.csv' OVERWRITE INTO TABLE WHICH_SCHEMA1;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/TEMP_OBSERV.csv' OVERWRITE INTO TABLE TEMP_OBSERV;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/T8.csv' OVERWRITE INTO TABLE T8;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/T4.csv' OVERWRITE INTO TABLE T4;
CREATE TABLE T240(STR240 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/T240.csv' OVERWRITE INTO TABLE T240;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/T2000.csv' OVERWRITE INTO TABLE T2000;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/T12.csv' OVERWRITE INTO TABLE T12;
CREATE TABLE T118(STR118 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/T118.csv' OVERWRITE INTO TABLE T118;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/T100.csv' OVERWRITE INTO TABLE T100;
CREATE TABLE SV(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/SV.csv' OVERWRITE INTO TABLE SV;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/SS.csv' OVERWRITE INTO TABLE SS;
CREATE TABLE RR(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/RR.csv' OVERWRITE INTO TABLE RR;
CREATE TABLE QQ(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/QQ.csv' OVERWRITE INTO TABLE QQ;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/BASE_TESTREPORT.csv' OVERWRITE INTO TABLE BASE_TESTREPORT;
CREATE TABLE AA(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0178/AA.csv' OVERWRITE INTO TABLE AA;
