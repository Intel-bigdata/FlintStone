...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/TESTREPORT.csv' OVERWRITE INTO TABLE TESTREPORT;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/DOLLARS_PER_POUND.csv' OVERWRITE INTO TABLE DOLLARS_PER_POUND;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/COST_PER_UNIT.csv' OVERWRITE INTO TABLE COST_PER_UNIT;
CREATE TABLE WORKS3(EMPNUM STRING,PNUM STRING,HOURS DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/WORKS3.csv' OVERWRITE INTO TABLE WORKS3;
CREATE TABLE WORKS(EMPNUM STRING,PNUM STRING,HOURS DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/WORKS.csv' OVERWRITE INTO TABLE WORKS;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/T6118REF.csv' OVERWRITE INTO TABLE T6118REF;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/T6.csv' OVERWRITE INTO TABLE T6;
CREATE TABLE T118(STR118 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/T118.csv' OVERWRITE INTO TABLE T118;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/SIZ3_F.csv' OVERWRITE INTO TABLE SIZ3_F;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/SIZ1_P.csv' OVERWRITE INTO TABLE SIZ1_P;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/SIZ1_F.csv' OVERWRITE INTO TABLE SIZ1_F;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/PROJ_P.csv' OVERWRITE INTO TABLE PROJ_P;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/PROJ_M.csv' OVERWRITE INTO TABLE PROJ_M;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/PROJ3.csv' OVERWRITE INTO TABLE PROJ3;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/PROJ.csv' OVERWRITE INTO TABLE PROJ;
CREATE TABLE MID1(P_KEY DOUBLE,F_KEY DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/MID1.csv' OVERWRITE INTO TABLE MID1;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/MEASURE_TABLE.csv' OVERWRITE INTO TABLE MEASURE_TABLE;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/EXPERIENCE.csv' OVERWRITE INTO TABLE EXPERIENCE;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/EXACT_DEF.csv' OVERWRITE INTO TABLE EXACT_DEF;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/EMP.csv' OVERWRITE INTO TABLE EMP;
CREATE TABLE ECCO(C1 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/ECCO.csv' OVERWRITE INTO TABLE ECCO;
CREATE TABLE DEPT(DNO DOUBLE,DNAME STRING,DEAN STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/DEPT.csv' OVERWRITE INTO TABLE DEPT;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/C_TRANSACTION.csv' OVERWRITE INTO TABLE C_TRANSACTION;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/CURRENCY_TABLE.csv' OVERWRITE INTO TABLE CURRENCY_TABLE;
CREATE TABLE COMMODITY(C_NUM DOUBLE,C_NAME STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/COMMODITY.csv' OVERWRITE INTO TABLE COMMODITY;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/CHAR_DEFAULT.csv' OVERWRITE INTO TABLE CHAR_DEFAULT;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/APPROX_DEF.csv' OVERWRITE INTO TABLE APPROX_DEF;
CREATE TABLE ACR_SCH_P(P1 DOUBLE,P2 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/0021/ACR_SCH_P.csv' OVERWRITE INTO TABLE ACR_SCH_P;
