...
LOAD DATA LOCAL INPATH '_datapath_/plusd/1032/SALE_ITEMS.csv' OVERWRITE INTO TABLE SALE_ITEMS;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/1032/RET_CATALOG.csv' OVERWRITE INTO TABLE RET_CATALOG;
...
LOAD DATA LOCAL INPATH '_datapath_/plusd/1032/FOUR_TYPES.csv' OVERWRITE INTO TABLE FOUR_TYPES;
CREATE TABLE CPREF(KCR DOUBLE,JUNK2 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/1032/CPREF.csv' OVERWRITE INTO TABLE CPREF;
CREATE TABLE CPBASE(KC DOUBLE,JUNK1 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '_datapath_/plusd/1032/CPBASE.csv' OVERWRITE INTO TABLE CPBASE;
