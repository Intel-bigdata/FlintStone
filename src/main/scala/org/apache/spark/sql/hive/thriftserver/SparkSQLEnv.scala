...
private[hive] object SparkSQLEnv extends Logging {
  ...
  def init() {
    if (hiveContext == null) {
      ...
      hiveContext = new FlintContext(sparkContext)
      ...
      // TODO maybe not set dialect to Flint here.
      hiveContext.setConf("spark.sql.dialect", classOf[CalciteDialect].getCanonicalName)
