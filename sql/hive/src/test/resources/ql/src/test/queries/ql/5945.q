...
SELECT AVG(S_GRADE), COUNT(S_GRADE), S_EMPNUM FROM STAFF GROUP BY S_EMPNUM HAVING S_EMPNUM > 'E1 ' AND EXISTS (SELECT * FROM STAFF WHERE S_EMPNUM > (SELECT MIN(S_EMPNUM) FROM STAFF WHERE S_EMPNUM NOT IN ('E1 ', 'E2 ', 'E3 ', 'E4 ', 'E5 ')));
