...
SELECT AVG(W_HOURS), W_EMPNUM FROM WORKS WHERE 'E1 ' < W_PNUM OR NOT EXISTS (SELECT * FROM STAFF WHERE S_EMPNUM > 'E3 ' AND S_GRADE BETWEEN 11 AND 16) GROUP BY W_EMPNUM;
