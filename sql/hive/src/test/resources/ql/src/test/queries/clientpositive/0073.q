...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0073/UUSIG.csv' OVERWRITE INTO TABLE UUSIG;
CREATE TABLE UUUSIG(IRREVERENT DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0073/UUUSIG.csv' OVERWRITE INTO TABLE UUUSIG;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0073/USIG.csv' OVERWRITE INTO TABLE USIG;
