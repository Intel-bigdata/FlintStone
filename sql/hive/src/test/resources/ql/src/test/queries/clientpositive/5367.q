...
SELECT P_PTYPE, P_PNAME, P_ENDDATE, P_BUDGET FROM PROJ WHERE P_ENDDATE BETWEEN (SELECT MIN(P_ENDDATE) FROM PROJ WHERE P_PNUM < 'P6 ') AND DATE '2012-05-06' AND P_BUDGET IS NOT NULL;
