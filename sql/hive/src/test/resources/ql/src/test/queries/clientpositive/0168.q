...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/V_WORKS3.csv' OVERWRITE INTO TABLE V_WORKS3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/V_WORKS2.csv' OVERWRITE INTO TABLE V_WORKS2;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/V_WORKS1.csv' OVERWRITE INTO TABLE V_WORKS1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/VSTAFF3.csv' OVERWRITE INTO TABLE VSTAFF3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/UPDATE_VIEW9.csv' OVERWRITE INTO TABLE UPDATE_VIEW9;
CREATE TABLE UPDATE_VIEW8(EMPNUM STRING,EMPNAME STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/UPDATE_VIEW8.csv' OVERWRITE INTO TABLE UPDATE_VIEW8;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/UPDATE_VIEW7.csv' OVERWRITE INTO TABLE UPDATE_VIEW7;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/UPDATE_VIEW6.csv' OVERWRITE INTO TABLE UPDATE_VIEW6;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/UPDATE_VIEW5.csv' OVERWRITE INTO TABLE UPDATE_VIEW5;
CREATE TABLE UPDATE_VIEW4(PNUM STRING,EMPNUM STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/UPDATE_VIEW4.csv' OVERWRITE INTO TABLE UPDATE_VIEW4;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/UPDATE_VIEW3.csv' OVERWRITE INTO TABLE UPDATE_VIEW3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/UPDATE_VIEW2.csv' OVERWRITE INTO TABLE UPDATE_VIEW2;
CREATE TABLE UPDATE_VIEW1(CITY STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/UPDATE_VIEW1.csv' OVERWRITE INTO TABLE UPDATE_VIEW1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/TESTREPORT.csv' OVERWRITE INTO TABLE TESTREPORT;
CREATE TABLE TEMP_SS(EMPNUM STRING,GRADE DOUBLE,CITY STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/TEMP_SS.csv' OVERWRITE INTO TABLE TEMP_SS;
CREATE TABLE SUBSP(EMPNUM STRING,PNUM STRING,HOURS DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/SUBSP.csv' OVERWRITE INTO TABLE SUBSP;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/STAFF_WORKS_DESIGN.csv' OVERWRITE INTO TABLE STAFF_WORKS_DESIGN;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/STAFFV2_VIEW.csv' OVERWRITE INTO TABLE STAFFV2_VIEW;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/STAFFV2.csv' OVERWRITE INTO TABLE STAFFV2;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/STAFFV1.csv' OVERWRITE INTO TABLE STAFFV1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/STAFF2.csv' OVERWRITE INTO TABLE STAFF2;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/SET_TEST.csv' OVERWRITE INTO TABLE SET_TEST;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/MULTI_YEAR_OBSERV.csv' OVERWRITE INTO TABLE MULTI_YEAR_OBSERV;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/EXTREME_TEMPS.csv' OVERWRITE INTO TABLE EXTREME_TEMPS;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/DUP_COL.csv' OVERWRITE INTO TABLE DUP_COL;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/DOMAIN_VIEW.csv' OVERWRITE INTO TABLE DOMAIN_VIEW;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/CELSIUS_OBSERV.csv' OVERWRITE INTO TABLE CELSIUS_OBSERV;
CREATE TABLE WORKS1(EMPNUM STRING,PNUM STRING,HOURS DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/WORKS1.csv' OVERWRITE INTO TABLE WORKS1;
CREATE TABLE WORKS(EMPNUM STRING,PNUM STRING,HOURS DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/WORKS.csv' OVERWRITE INTO TABLE WORKS;
CREATE TABLE WHICH_SCHEMA1(C1 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/WHICH_SCHEMA1.csv' OVERWRITE INTO TABLE WHICH_SCHEMA1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/VTABLE.csv' OVERWRITE INTO TABLE VTABLE;
CREATE TABLE UPUNIQ(NUMKEY DOUBLE,COL2 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/UPUNIQ.csv' OVERWRITE INTO TABLE UPUNIQ;
CREATE TABLE TOKENS(PROG_NO DOUBLE,TOKEN_NO DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/TOKENS.csv' OVERWRITE INTO TABLE TOKENS;
CREATE TABLE TMP(T1 STRING,T2 DOUBLE,T3 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/TMP.csv' OVERWRITE INTO TABLE TMP;
CREATE TABLE TEXT80(TEXXT STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/TEXT80.csv' OVERWRITE INTO TABLE TEXT80;
CREATE TABLE TEXT512(TEXXT STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/TEXT512.csv' OVERWRITE INTO TABLE TEXT512;
CREATE TABLE TEXT256(TEXXT STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/TEXT256.csv' OVERWRITE INTO TABLE TEXT256;
CREATE TABLE TEXT240(TEXXT STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/TEXT240.csv' OVERWRITE INTO TABLE TEXT240;
CREATE TABLE TEXT132(TEXXT STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/TEXT132.csv' OVERWRITE INTO TABLE TEXT132;
CREATE TABLE TEXT1024(TEXXT STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/TEXT1024.csv' OVERWRITE INTO TABLE TEXT1024;
CREATE TABLE TEMP_S(EMPNUM STRING,GRADE DOUBLE,CITY STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/TEMP_S.csv' OVERWRITE INTO TABLE TEMP_S;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/TEMP_OBSERV.csv' OVERWRITE INTO TABLE TEMP_OBSERV;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/T8.csv' OVERWRITE INTO TABLE T8;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/T4.csv' OVERWRITE INTO TABLE T4;
CREATE TABLE T240(STR240 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/T240.csv' OVERWRITE INTO TABLE T240;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/T2000.csv' OVERWRITE INTO TABLE T2000;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/T12.csv' OVERWRITE INTO TABLE T12;
CREATE TABLE T118(STR118 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/T118.csv' OVERWRITE INTO TABLE T118;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/T100.csv' OVERWRITE INTO TABLE T100;
CREATE TABLE SV(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/SV.csv' OVERWRITE INTO TABLE SV;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/STAFF4.csv' OVERWRITE INTO TABLE STAFF4;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/STAFF3.csv' OVERWRITE INTO TABLE STAFF3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/STAFF1.csv' OVERWRITE INTO TABLE STAFF1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/STAFF.csv' OVERWRITE INTO TABLE STAFF;
CREATE TABLE SS(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/SS.csv' OVERWRITE INTO TABLE SS;
CREATE TABLE RR(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/RR.csv' OVERWRITE INTO TABLE RR;
CREATE TABLE QQ(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/QQ.csv' OVERWRITE INTO TABLE QQ;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/PROJ1.csv' OVERWRITE INTO TABLE PROJ1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/PROJ.csv' OVERWRITE INTO TABLE PROJ;
CREATE TABLE PP_7(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/PP_7.csv' OVERWRITE INTO TABLE PP_7;
CREATE TABLE PP_15(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/PP_15.csv' OVERWRITE INTO TABLE PP_15;
CREATE TABLE PP(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/PP.csv' OVERWRITE INTO TABLE PP;
CREATE TABLE P7(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/P7.csv' OVERWRITE INTO TABLE P7;
CREATE TABLE P15_7(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/P15_7.csv' OVERWRITE INTO TABLE P15_7;
CREATE TABLE P15_15(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/P15_15.csv' OVERWRITE INTO TABLE P15_15;
CREATE TABLE P15(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/P15.csv' OVERWRITE INTO TABLE P15;
CREATE TABLE P12(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/P12.csv' OVERWRITE INTO TABLE P12;
CREATE TABLE P1(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/P1.csv' OVERWRITE INTO TABLE P1;
CREATE TABLE OO(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/OO.csv' OVERWRITE INTO TABLE OO;
CREATE TABLE NN(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/NN.csv' OVERWRITE INTO TABLE NN;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/BASE_TESTREPORT.csv' OVERWRITE INTO TABLE BASE_TESTREPORT;
CREATE TABLE AA(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0168/AA.csv' OVERWRITE INTO TABLE AA;
