...
SELECT COUNT(*) FROM STAFF, WORKS WHERE S_EMPNUM = W_EMPNUM AND S_EMPNUM > 'E1 ' AND EXISTS (SELECT * FROM STAFF WHERE S_EMPNUM > (SELECT MIN(W_EMPNUM) FROM WORKS WHERE W_PNUM = 'P4 ' OR W_PNUM = 'P5 ' AND W_HOURS IN (20, 40, 80)));
