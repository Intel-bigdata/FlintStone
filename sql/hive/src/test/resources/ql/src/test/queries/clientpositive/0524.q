...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0524/VSTAFF3.csv' OVERWRITE INTO TABLE VSTAFF3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0524/STAFF3.csv' OVERWRITE INTO TABLE STAFF3;
