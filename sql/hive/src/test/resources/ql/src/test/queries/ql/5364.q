...
SELECT P_PTYPE, P_PNAME, P_ENDDATE, P_BUDGET FROM PROJ WHERE P_STARTDATE > DATE '2009-02-03' AND P_PNUM NOT IN (SELECT S_EMPNUM FROM STAFF WHERE S_GRADE > 11 AND P_PNUM = S_EMPNUM);
