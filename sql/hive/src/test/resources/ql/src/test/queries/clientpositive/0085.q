...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0085/VSTAFF3.csv' OVERWRITE INTO TABLE VSTAFF3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0085/STAFF3.csv' OVERWRITE INTO TABLE STAFF3;
