...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0245/TEMP_SS.csv' OVERWRITE INTO TABLE TEMP_SS;
CREATE TABLE SS(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0245/SS.csv' OVERWRITE INTO TABLE SS;
SELECT * FROM SS;
