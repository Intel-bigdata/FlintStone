...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0800/EXON.csv' OVERWRITE INTO TABLE EXON;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0800/XX.csv' OVERWRITE INTO TABLE XX;
CREATE TABLE X(A DOUBLE,B DOUBLE,C DOUBLE,D DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0800/X.csv' OVERWRITE INTO TABLE X;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0800/EXTREME_TEMPS.csv' OVERWRITE INTO TABLE EXTREME_TEMPS;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0800/TEXT80.csv' OVERWRITE INTO TABLE TEXT80;
CREATE TABLE TEXT512(TEXXT STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0800/TEXT512.csv' OVERWRITE INTO TABLE TEXT512;
CREATE TABLE TEXT256(TEXXT STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0800/TEXT256.csv' OVERWRITE INTO TABLE TEXT256;
CREATE TABLE TEXT240(TEXXT STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0800/TEXT240.csv' OVERWRITE INTO TABLE TEXT240;
CREATE TABLE TEXT132(TEXXT STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0800/TEXT132.csv' OVERWRITE INTO TABLE TEXT132;
CREATE TABLE TEXT1024(TEXXT STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0800/TEXT1024.csv' OVERWRITE INTO TABLE TEXT1024;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0800/NEXTKEY.csv' OVERWRITE INTO TABLE NEXTKEY;
