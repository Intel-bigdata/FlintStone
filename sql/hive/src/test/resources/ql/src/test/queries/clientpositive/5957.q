...
SELECT AVG(S_GRADE), COUNT(S_GRADE), S_EMPNAME, S_EMPNUM FROM STAFF GROUP BY S_EMPNAME, S_EMPNUM HAVING EXISTS (SELECT P_CITY FROM PROJ GROUP BY P_CITY HAVING MIN(P_PNUM) NOT IN ('P2 ', 'P3 ', 'P1 ', 'P4 ', 'P5 ')) AND S_EMPNAME LIKE '___%' AND S_EMPNUM NOT LIKE '_3 ';
