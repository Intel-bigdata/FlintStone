...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0137/TEMP_SS.csv' OVERWRITE INTO TABLE TEMP_SS;
CREATE TABLE TEMP_S(EMPNUM STRING,GRADE DOUBLE,CITY STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0137/TEMP_S.csv' OVERWRITE INTO TABLE TEMP_S;
