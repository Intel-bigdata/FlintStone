...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0694/CHANGGVIEW.csv' OVERWRITE INTO TABLE CHANGGVIEW;
CREATE TABLE REFERENCE_CHANGG(NAAM STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0694/REFERENCE_CHANGG.csv' OVERWRITE INTO TABLE REFERENCE_CHANGG;
CREATE TABLE CHANGG(NAAM STRING,AGE DOUBLE,NUMBRR STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0694/CHANGG.csv' OVERWRITE INTO TABLE CHANGG;
