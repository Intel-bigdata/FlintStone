...
LOAD DATA LOCAL INPATH '/home/cherry/sotc_cloud-panthera-nist-test/plusd/0981/SIZ3_P10.csv' OVERWRITE INTO TABLE SIZ3_P10;
CREATE TABLE SIZ3_P1(F1 STRING,F2 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH '/home/cherry/sotc_cloud-panthera-nist-test/plusd/0981/SIZ3_P1.csv' OVERWRITE INTO TABLE SIZ3_P1;
