...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/V_WORKS3.csv' OVERWRITE INTO TABLE V_WORKS3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/V_WORKS2.csv' OVERWRITE INTO TABLE V_WORKS2;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/V_WORKS1.csv' OVERWRITE INTO TABLE V_WORKS1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/VSTAFF3.csv' OVERWRITE INTO TABLE VSTAFF3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/STAFF_WORKS_DESIGN.csv' OVERWRITE INTO TABLE STAFF_WORKS_DESIGN;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/STAFFV2_VIEW.csv' OVERWRITE INTO TABLE STAFFV2_VIEW;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/STAFFV2.csv' OVERWRITE INTO TABLE STAFFV2;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/STAFFV1.csv' OVERWRITE INTO TABLE STAFFV1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/STAFF2.csv' OVERWRITE INTO TABLE STAFF2;
CREATE TABLE WORKS1(EMPNUM STRING,PNUM STRING,HOURS DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/WORKS1.csv' OVERWRITE INTO TABLE WORKS1;
CREATE TABLE WORKS(EMPNUM STRING,PNUM STRING,HOURS DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/WORKS.csv' OVERWRITE INTO TABLE WORKS;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/STAFF4.csv' OVERWRITE INTO TABLE STAFF4;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/STAFF3.csv' OVERWRITE INTO TABLE STAFF3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/STAFF1.csv' OVERWRITE INTO TABLE STAFF1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/STAFF.csv' OVERWRITE INTO TABLE STAFF;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/PROJ1.csv' OVERWRITE INTO TABLE PROJ1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0143/PROJ.csv' OVERWRITE INTO TABLE PROJ;
