...
SELECT COUNT(*) FROM STAFF WHERE 'E1 ' < S_EMPNUM OR NOT EXISTS (SELECT * FROM STAFF WHERE S_EMPNUM IN (SELECT S_EMPNUM FROM STAFF WHERE S_EMPNUM IN ('E1 ', 'E2 ', 'E3 ', 'E4 ', 'E5 ')));
