...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0893/TT2.csv' OVERWRITE INTO TABLE TT2;
CREATE TABLE TT(TTA DOUBLE,TTB DOUBLE,TTC DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0893/TT.csv' OVERWRITE INTO TABLE TT;
