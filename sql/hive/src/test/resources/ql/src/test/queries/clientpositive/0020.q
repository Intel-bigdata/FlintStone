...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0020/PROJ_P.csv' OVERWRITE INTO TABLE PROJ_P;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0020/PROJ_M.csv' OVERWRITE INTO TABLE PROJ_M;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0020/PROJ3.csv' OVERWRITE INTO TABLE PROJ3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0020/PROJ.csv' OVERWRITE INTO TABLE PROJ;
