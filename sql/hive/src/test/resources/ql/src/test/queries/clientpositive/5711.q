...
SELECT COUNT(*), S_CITY FROM STAFF WHERE EXISTS (SELECT * FROM STAFF WHERE EXISTS (SELECT S_EMPNUM FROM STAFF WHERE S_EMPNUM <> 'E7 ')) AND S_EMPNUM > 'E1 ' GROUP BY S_CITY;
