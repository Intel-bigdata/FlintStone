...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0299/V_WORKS1.csv' OVERWRITE INTO TABLE V_WORKS1;
CREATE TABLE WORKS1(EMPNUM STRING,PNUM STRING,HOURS DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0299/WORKS1.csv' OVERWRITE INTO TABLE WORKS1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0299/STAFF1.csv' OVERWRITE INTO TABLE STAFF1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0299/PROJ1.csv' OVERWRITE INTO TABLE PROJ1;
