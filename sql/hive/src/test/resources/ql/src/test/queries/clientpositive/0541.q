...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0541/STAFF6_WITH_GRADES.csv' OVERWRITE INTO TABLE STAFF6_WITH_GRADES;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0541/STAFF6.csv' OVERWRITE INTO TABLE STAFF6;
