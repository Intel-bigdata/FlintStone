...
SELECT AVG(S_GRADE), COUNT(S_GRADE), S_CITY, S_EMPNAME FROM STAFF GROUP BY S_CITY, S_EMPNAME HAVING S_EMPNAME > 'B*' AND COUNT(*) < (SELECT MIN(W_HOURS) FROM WORKS WHERE W_PNUM > 'P2 ');
