...
SELECT AVG(W_HOURS+P_BUDGET/100), W_EMPNUM FROM WORKS, PROJ WHERE W_PNUM = P_PNUM AND P_ENDDATE BETWEEN DATE '2007-05-06' AND (SELECT MAX(P_ENDDATE) FROM PROJ WHERE P_PNUM < 'P6 ') GROUP BY W_EMPNUM;
