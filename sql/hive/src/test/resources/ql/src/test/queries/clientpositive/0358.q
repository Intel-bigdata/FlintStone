...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0358/JJ_20.csv' OVERWRITE INTO TABLE JJ_20;
CREATE TABLE JJ(FLOATTEST FLOAT) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0358/JJ.csv' OVERWRITE INTO TABLE JJ;
