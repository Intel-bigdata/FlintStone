...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0708/VSTAFF3.csv' OVERWRITE INTO TABLE VSTAFF3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0708/STAFF_WORKS_DESIGN.csv' OVERWRITE INTO TABLE STAFF_WORKS_DESIGN;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0708/STAFFV2_VIEW.csv' OVERWRITE INTO TABLE STAFFV2_VIEW;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0708/STAFFV2.csv' OVERWRITE INTO TABLE STAFFV2;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0708/STAFFV1.csv' OVERWRITE INTO TABLE STAFFV1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0708/STAFF2.csv' OVERWRITE INTO TABLE STAFF2;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0708/STAFF4.csv' OVERWRITE INTO TABLE STAFF4;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0708/STAFF3.csv' OVERWRITE INTO TABLE STAFF3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0708/STAFF1.csv' OVERWRITE INTO TABLE STAFF1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0708/STAFF.csv' OVERWRITE INTO TABLE STAFF;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0708/WORKWEEK.csv' OVERWRITE INTO TABLE WORKWEEK;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0708/STAFF_DUP.csv' OVERWRITE INTO TABLE STAFF_DUP;
CREATE TABLE STAFF(EMPNUM STRING,EMPNAME STRING,GRADE DOUBLE,CITY STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0708/STAFF.csv' OVERWRITE INTO TABLE STAFF;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0708/STAFF66.csv' OVERWRITE INTO TABLE STAFF66;
