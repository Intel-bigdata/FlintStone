...
SELECT COUNT(*) FROM STAFF, WORKS GROUP BY S_EMPNUM, S_GRADE, S_EMPNAME HAVING S_EMPNAME LIKE '___%' AND S_EMPNUM NOT LIKE '_3 ' AND S_GRADE BETWEEN 11 AND (SELECT MAX(S_GRADE) FROM STAFF WHERE S_EMPNAME > 'AA');
