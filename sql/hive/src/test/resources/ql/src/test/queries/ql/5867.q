...
SELECT COUNT(*), W_HOURS, P_PNUM, W_PNUM, P_ENDDATE FROM WORKS CROSS JOIN PROJ GROUP BY W_HOURS, P_PNUM, W_PNUM, P_ENDDATE HAVING W_PNUM = P_PNUM AND P_ENDDATE BETWEEN DATE '2007-05-06' AND (SELECT MAX(P_ENDDATE) FROM PROJ WHERE P_PNUM < 'P6 ');
