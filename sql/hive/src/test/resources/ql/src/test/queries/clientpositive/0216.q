...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0216/V_WORKS3.csv' OVERWRITE INTO TABLE V_WORKS3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0216/V_WORKS2.csv' OVERWRITE INTO TABLE V_WORKS2;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0216/V_WORKS1.csv' OVERWRITE INTO TABLE V_WORKS1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0216/STAFF_WORKS_DESIGN.csv' OVERWRITE INTO TABLE STAFF_WORKS_DESIGN;
CREATE TABLE WORKS1(EMPNUM STRING,PNUM STRING,HOURS DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0216/WORKS1.csv' OVERWRITE INTO TABLE WORKS1;
CREATE TABLE WORKS(EMPNUM STRING,PNUM STRING,HOURS DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0216/WORKS.csv' OVERWRITE INTO TABLE WORKS;
