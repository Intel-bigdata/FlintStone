...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0839/TEST6840B.csv' OVERWRITE INTO TABLE TEST6840B;
CREATE TABLE TEST6840A(NUM_A DOUBLE,CH_A STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0839/TEST6840A.csv' OVERWRITE INTO TABLE TEST6840A;
