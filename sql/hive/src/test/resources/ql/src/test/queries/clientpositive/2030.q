...
SELECT EMPNUM, HOURS FROM WORKS GROUP BY HOURS, EMPNUM HAVING EMPNUM IN (SELECT EMPNUM FROM STAFF WHERE STAFF.EMPNAME LIKE '%l%' AND STAFF.EMPNUM = WORKS.EMPNUM AND WORKS.HOURS != 40);
