...
SELECT AVG(W_HOURS), W_EMPNUM, W_PNUM FROM WORKS WHERE W_PNUM > (SELECT MIN(P_PNUM) FROM PROJ WHERE P_ENDDATE < DATE '2011-09-14') GROUP BY W_EMPNUM, W_PNUM HAVING W_EMPNUM <> W_PNUM;
