...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0393/STAFFV2_VIEW.csv' OVERWRITE INTO TABLE STAFFV2_VIEW;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0393/STAFFV2.csv' OVERWRITE INTO TABLE STAFFV2;
