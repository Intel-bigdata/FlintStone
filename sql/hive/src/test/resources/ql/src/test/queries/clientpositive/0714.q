...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0714/QUALSTAR.csv' OVERWRITE INTO TABLE QUALSTAR;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0714/CORRQUALSTAR.csv' OVERWRITE INTO TABLE CORRQUALSTAR;
