...
SELECT AVG(W_HOURS+P_BUDGET/100), W_EMPNUM, P_CITY FROM WORKS, PROJ WHERE W_PNUM = P_PNUM GROUP BY W_EMPNUM, P_CITY HAVING P_CITY IN ('Deale          ', 'Vienna         ', 'Akron          ', 'Toyko          ');
