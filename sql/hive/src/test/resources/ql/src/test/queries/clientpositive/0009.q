...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0009/VDD.csv' OVERWRITE INTO TABLE VDD;
CREATE TABLE DD(CHARTEST STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0009/DD.csv' OVERWRITE INTO TABLE DD;
