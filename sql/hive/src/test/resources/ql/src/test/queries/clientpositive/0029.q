...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0029/SIZ2_F10.csv' OVERWRITE INTO TABLE SIZ2_F10;
CREATE TABLE SIZ2_F1(F1 STRING,F2 STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0029/SIZ2_F1.csv' OVERWRITE INTO TABLE SIZ2_F1;
