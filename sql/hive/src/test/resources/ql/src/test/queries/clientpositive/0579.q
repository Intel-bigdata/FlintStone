...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0579/WORKS3.csv' OVERWRITE INTO TABLE WORKS3;
CREATE TABLE WORKS(EMPNUM STRING,PNUM STRING,HOURS DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0579/WORKS.csv' OVERWRITE INTO TABLE WORKS;
