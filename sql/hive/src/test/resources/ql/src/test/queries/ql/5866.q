...
SELECT COUNT(*), W_HOURS, P_CITY, W_PNUM, P_PNUM FROM WORKS CROSS JOIN PROJ GROUP BY P_CITY, W_HOURS, W_PNUM, P_PNUM HAVING W_PNUM = P_PNUM AND P_CITY IN ('Deale          ', 'Vienna         ', 'Akron          ', 'Toyko          ');
