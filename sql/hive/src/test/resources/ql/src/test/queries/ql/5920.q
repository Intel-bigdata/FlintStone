...
SELECT COUNT(*) FROM STAFF GROUP BY S_EMPNUM, S_EMPNAME HAVING EXISTS (SELECT P_BUDGET FROM PROJ GROUP BY P_BUDGET HAVING MIN(P_PNUM) NOT IN ('P2 ', 'P3 ', 'P1 ', 'P4 ', 'P5 ')) AND S_EMPNAME LIKE '___%' AND S_EMPNUM NOT LIKE '_3 ';
