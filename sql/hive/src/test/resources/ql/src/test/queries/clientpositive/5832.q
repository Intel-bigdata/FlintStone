...
SELECT COUNT(*) FROM STAFF, WORKS GROUP BY S_GRADE HAVING S_GRADE BETWEEN 11 AND (SELECT MAX(S_GRADE) FROM STAFF WHERE S_EMPNAME > 'AA') AND S_GRADE BETWEEN 12 AND 18;
