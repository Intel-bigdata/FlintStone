...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0383/PROJ1.csv' OVERWRITE INTO TABLE PROJ1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0383/PROJ.csv' OVERWRITE INTO TABLE PROJ;
