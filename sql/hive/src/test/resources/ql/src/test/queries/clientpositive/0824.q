...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0824/STAFF_CTS2.csv' OVERWRITE INTO TABLE STAFF_CTS2;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0824/STAFF_CTS.csv' OVERWRITE INTO TABLE STAFF_CTS;
CREATE TABLE STAFFZ(EMPNUM STRING,SALARY DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0824/STAFFZ.csv' OVERWRITE INTO TABLE STAFFZ;
CREATE TABLE STAFFD(EMPNUM STRING,GRADE DOUBLE,MGR STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0824/STAFFD.csv' OVERWRITE INTO TABLE STAFFD;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0824/STAFFC.csv' OVERWRITE INTO TABLE STAFFC;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0824/STAFFB.csv' OVERWRITE INTO TABLE STAFFB;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0824/STAFFA.csv' OVERWRITE INTO TABLE STAFFA;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0824/STAFF7.csv' OVERWRITE INTO TABLE STAFF7;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0824/STAFF4.csv' OVERWRITE INTO TABLE STAFF4;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0824/STAFF3.csv' OVERWRITE INTO TABLE STAFF3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0824/STAFF1.csv' OVERWRITE INTO TABLE STAFF1;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0824/STAFF.csv' OVERWRITE INTO TABLE STAFF;
