...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0734/INCOMPLETES.csv' OVERWRITE INTO TABLE INCOMPLETES;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0734/COMPLETES.csv' OVERWRITE INTO TABLE COMPLETES;
