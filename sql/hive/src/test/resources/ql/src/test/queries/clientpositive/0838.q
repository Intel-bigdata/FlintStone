...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0838/TEST6740B.csv' OVERWRITE INTO TABLE TEST6740B;
CREATE TABLE TEST6740A(TNUM DOUBLE,TCHARA STRING) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0838/TEST6740A.csv' OVERWRITE INTO TABLE TEST6740A;
