...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0082/VSTAFF3.csv' OVERWRITE INTO TABLE VSTAFF3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0082/STAFF3.csv' OVERWRITE INTO TABLE STAFF3;
