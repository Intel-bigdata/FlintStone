...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0359/MM2.csv' OVERWRITE INTO TABLE MM2;
CREATE TABLE MM(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0359/MM.csv' OVERWRITE INTO TABLE MM;
