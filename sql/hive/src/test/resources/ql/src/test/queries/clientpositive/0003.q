...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0003/VSTAFF3.csv' OVERWRITE INTO TABLE VSTAFF3;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0003/STAFF3.csv' OVERWRITE INTO TABLE STAFF3;
