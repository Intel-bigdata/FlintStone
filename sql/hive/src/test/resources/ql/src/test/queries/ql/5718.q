...
SELECT COUNT(*), S_CITY FROM STAFF WHERE S_GRADE BETWEEN (SELECT AVG(S_GRADE) FROM STAFF WHERE S_EMPNAME > (SELECT MIN(W_EMPNUM) FROM WORKS WHERE W_HOURS BETWEEN 0 AND 100)) AND 18 GROUP BY S_CITY;
