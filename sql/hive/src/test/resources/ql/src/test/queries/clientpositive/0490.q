...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0490/VVTABLE.csv' OVERWRITE INTO TABLE VVTABLE;
...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0490/VTABLE.csv' OVERWRITE INTO TABLE VTABLE;
