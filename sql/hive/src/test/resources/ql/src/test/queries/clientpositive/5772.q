...
SELECT AVG(W_HOURS), W_EMPNUM FROM WORKS WHERE W_HOURS IS NOT NULL AND W_PNUM IS NOT NULL AND W_HOURS <> (SELECT MAX(S_GRADE) FROM STAFF WHERE W_EMPNUM < S_EMPNUM) GROUP BY W_EMPNUM;
