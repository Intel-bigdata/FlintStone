...
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0921/P15_7.csv' OVERWRITE INTO TABLE P15_7;
CREATE TABLE P15_15(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0921/P15_15.csv' OVERWRITE INTO TABLE P15_15;
CREATE TABLE P15(NUMTEST DOUBLE) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' STORED AS TEXTFILE;
LOAD DATA LOCAL INPATH 'src/test/resources/plusd/0921/P15.csv' OVERWRITE INTO TABLE P15;
