...
select s_empnum from staff where exists (select * from proj where p_city = s_city and (p_pnum in ('P1 ', 'P3 ', 'P9 ') or p_pnum in (select w_pnum from works where w_hours>100))) and s_grade>10;
