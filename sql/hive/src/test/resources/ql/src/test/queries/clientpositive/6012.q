...
SELECT COUNT(*), S_CITY, S_GRADE FROM STAFF WHERE S_EMPNUM > 'E1 ' AND EXISTS (SELECT * FROM STAFF WHERE S_EMPNUM > 'E8 ') GROUP BY S_CITY, S_GRADE HAVING S_CITY IS NULL AND S_GRADE IS NOT NULL;
